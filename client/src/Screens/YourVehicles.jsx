...
//   const navigate = useNavigate();
  ...
  return (
    <div className="min-h-screen bg-transparent dark:bg-gray-900 text-white dark:text-gray-100 p-8 mt-20">
      ...
      {isLoading ? (
        <div className="text-center">Loading your vehicles...</div>
      ) : (
        <>
          <div className="flex justify-between items-center mb-4">
            {/* <h2 className="text-2xl font-semibold">Owned Vehicles</h2> */}
            <div className="text-sm text-gray-500">{vehicles.length} vehicles found</div>
          </div>
